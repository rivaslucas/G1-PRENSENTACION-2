...
function enviarMensajeWhatsapp(usuarioLogueado) {
  ...
  const urlWhatsapp = `https://wa.me/543865210198?text=${encodeURIComponent(`¡Hola! Aquí está mi presupuesto: https://distrymundo.netlify.app/presupuesto.html?datos=${datosCodificados}`)}`;
